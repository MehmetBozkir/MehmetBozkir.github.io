    ...
    <div className="h-full flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 text-xl">
      ...
      <div className="hidden md:flex gap-4 w-1/3">
        ...
        <Link href="https://medium.com/@mehmetsalihbozkir" target="_blank">
          <Image src="/medium.svg" alt="" width={24} height={24} />
        </Link>
        <Link href="https://dev.to/mehmetsalihbozkir" target="_blank">
          <Image src="/devto.svg" alt="" width={24} height={24} />
        </Link>
        <Link
          href="https://stackoverflow.com/users/23094164/mehmet-salih-bozk%c4%b1r"
          target="_blank"
        >
          <Image src="/stackoverflow.svg" alt="" width={24} height={24} />
        </Link>
        <Link
        ...
        <Link href="https://linktr.ee/MehmetSalihBozkir" target="_blank">
          <Image src="/Linktree.png" alt="" width={20} height={20} />
        </Link>
      </div>
